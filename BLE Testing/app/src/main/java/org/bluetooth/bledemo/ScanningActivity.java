...
/******************************************************************************
ScanningActivity is class that is part of the ECG Monitoring App 
...
This program is essentially the "Central" device, scanning for possible BLE
devices and putting them into a list to be shown on the phone.
...
public class ScanningActivity extends ListActivity {
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        //Intent - what passes between screens
