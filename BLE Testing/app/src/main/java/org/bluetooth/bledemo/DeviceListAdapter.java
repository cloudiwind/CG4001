...
/******************************************************************************
DeviceListAdapter is class that is part of the ECG Monitoring App 
...
This program refreshes the proper values into the getView on the device side.
It puts all devices that are found after scanning into a list and outputs them.
